...
$(function () {
    ...
    // events
    $("#ddl_page_id").on("change", function(e){
        let displayName = $(this).val();
        console.log(displayName);

        let reportName = get_reportName_by_pageDisplayName(displayName);
        console.log(reportName);
        pbie_report.setPage(reportName);
        // can use pbie_report.on('pageChanged', event => {})
    });

    get_reportName_by_pageDisplayName = function(displayName) {
        console.log(pbie_pages);
        console.log("In get_reportName_by_pageDisplayName");

        for (var key in pbie_pages) {
            let cpage = pbie_pages[key];
            console.log(cpage);
            
            if(cpage.displayName==displayName) {
                return cpage.name;
            }
        }
