...
$(function () {
    ...
    $.ajax({
        type: "POST",
        //url: "https://gpsuxerbsc.execute-api.ap-southeast-2.amazonaws.com/dev",
        url: "http://0.0.0.0:5001/dev/fetch_resource",
        ...
        data: JSON.stringify({
            ...
            "geography_level": "lga"
        }), // just mock the parameters for now
        success: function (data) {
            console.log(data);
            embedData = $.parseJSON(JSON.stringify(data));
            reportLoadConfig.accessToken = embedData.access_token;

            // You can embed different reports as per your need
            reportLoadConfig.embedUrl = embedData.embed_url;
